...
class _HomePageState extends State<HomePage> {
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  whyHappyeasyRides(
                                    img:
                                        provider.arrWhyhappyeasy[0]['image'] ??
                                        "",
                                    text:
                                        provider.arrWhyhappyeasy[0]['title'] ??
                                        "",
                                  ),
                                  whyHappyeasyRides(
                                    img:
                                        provider.arrWhyhappyeasy[1]['image'] ??
                                        "",
                                    text:
                                        provider.arrWhyhappyeasy[1]['title'] ??
                                        "",
                                  ),
                                  whyHappyeasyRides(
                                    img:
                                        provider.arrWhyhappyeasy[2]['image'] ??
                                        "",
                                    text:
                                        provider.arrWhyhappyeasy[2]['title'] ??
                                        "",
                                  ),
                                ],
                              ),
                          ...
                          SingleChildScrollView(
                            ...
                            child: Row(
                              children: [
                                ...List.generate(provider.arrTestimonial.length, (
                                  index,
                                ) {
                                  return Container(
  ...
  //AppBar
      ...
      //                 controller: _searchController,
      //                 onChanged: (value) {
      //                   homePageProvider.setSearchText(value);
      //                 },
      //                 decoration: InputDecoration(
      //                   suffixIcon: GestureDetector(
      //                     onTap: () {},
